    ...
    detailArray.forEach( currentDetailValue => {
        ...
        if ( ToCPageNos
          && !writePageNoToArray ) {
            ...
            if ( print )
                text += `<p class="contentLayer"><b>${chapter}.${subChapterNo} ${title}</b></p>`;
            else
                text += `<p class="contentLayer"><b>${chapter}.${subChapterNo} <a href="#${helper.GetID( chapter + '.' + subChapterNo )}">${title}</a></b></p>`;
            ...
            if ( currentDetail.type == 'HEADING' ) {
                ...
                if ( ToCPageNos
                  && !writePageNoToArray ) {
                    ...
                    if ( print )
                        text += `<p class="contentLayer"><b>${chapterNo}. ${title}</b> ${pageNo}</p>`;
                    else
                        text += `<p class="contentLayer"><b>${chapterNo}. <a href="#${chapterNo}">${title}</a></b> ${pageNo}</p>`;
                }
                else {
                    if ( print )
